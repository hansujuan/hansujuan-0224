Vue.component('jc-customer-search-page', {
    ...
    <div id="app">
        ...
        <el-input v-model="username" placeholder="请输入用户名" style="width: auto;"></el-input>
        <el-input v-model="realName" placeholder="请输入客户姓名" style="width: auto;"></el-input>
        <el-input v-model="mobile" placeholder="请输入手机" style="width: auto;"></el-input>
        <el-input v-model="email" placeholder="请输入邮箱" style="width: auto;"></el-input>
