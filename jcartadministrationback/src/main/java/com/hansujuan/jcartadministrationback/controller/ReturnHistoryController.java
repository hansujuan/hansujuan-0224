...
import com.hansujuan.jcartadministrationback.service.ReturnHistoryService;
...
public class ReturnHistoryController {
    ...
    public List<ReturnHistoryListOutDTO> getListByReturnId(@RequestParam Integer returnId){
        ...
        List<ReturnHistoryListOutDTO> listOutDTOList = listByReturnId.stream().map(returnHistory -> {
